...
void Bureaucrat::signForm(Form &target)
{
    try
    {
        ...
        std::cout << GREEN_CLR << *this << ", signed " << target << END_CLR << std::endl;
    }
    catch (std::exception &e)
    {
        std::cout << RED_CLR << *this << ", couldn't sign " << target << " because " << e.what() << END_CLR << std::endl;
    }
}
...
void Bureaucrat::executeForm(Form const &form)
{
    ...
    {
        form.execute(*this);
        std::cout << GREEN_CLR << *this << ", executed " << form << END_CLR << std::endl;
    }
    catch (std::exception &e)
    {
        std::cout << RED_CLR << *this << ", couldn't execute " << form << " because " << e.what() << END_CLR << std::endl;
    }
}
